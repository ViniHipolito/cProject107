...
def goal_track(img,bbox):
    ...
    if(dist<=20):
        cv2.putText(img,"Ponto",(300,90),cv2.FONT_HERSHEY_SIMPLEX,0.7,(0,100,0),2)
...
def drawBox(img,bbox):
    ...
    cv2.putText(img,"Rastreando",(75,90),cv2.FONT_HERSHEY_SIMPLEX,0.7,(25,125,100),2)
...
while True:
   ...
   if success:
       ...
       cv2.putText(img, 'Rastereamento Falhado', (75, 90), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (10, 60, 180), 2)
